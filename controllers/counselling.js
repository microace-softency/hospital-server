...
router.put("/:id", async (req, res) => {
  ...
  const sqlUpdate =
    "UPDATE prescriptions SET selectedPackage = ?, packageAmount = ?, discount = ?, netAmount = ?, advance = ?, otDate = ?, source = ? WHERE id = ?";
...
router.put("/outdoor/:id", async (req, res) => {
  ...
  const sqlUpdate =
    "UPDATE outdoor_prescriptions SET selectedPackage = ?, packageAmount = ?, discount = ?, netAmount = ?, advance = ?, otDate = ?, source = ? WHERE id = ?";
